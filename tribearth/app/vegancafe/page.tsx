    ...
    <div className="text-slate-800 flex pt-32 flex-col w-full">
      <div className="flex gap-4 flex-col p-8 text-center">
        <h1 className="text-4xl md:text-5xl xl:text-6xl text-emerald-500/90">Vegan Boutique Cafe</h1>
          ...
          <Link href={"/"}>
            <p className="italic hover:text-emerald-500 shadow px-2 py-4 rounded-md bg-slate-400/40">"Our Vegan Cafe at heart is a mix of Ethiopian food, Swahili snacks and healthy Vegan bitings"</p>
          </Link>
      </div>
      <div className="flex border-spacing-2 p-2 shadow flex-col md:flex-row items-base justify-around gap-8 mx-4 my-8">
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4 items-center justify-center text-center p-2">
            <h1 className="font-semibold text-lg md:text-xl lg:text-2xl ">Healthy vegan snacks</h1>
            <p className="text-md md:text-lg lg:text-xl font-medium">With the right ingredients, baobab, coconut milk, moringa, chocolate, peanut butter, and mango deliciousness, our smoothie bowls are just the perfect meal in a bowl.</p>
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-4 items-center justify-center text-center p-2">
            <h1 className="font-semibold md:text-xl lg:text-2xl text-lg">Ethiopian platter and wraps</h1>
