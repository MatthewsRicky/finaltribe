    ...
    <div>
      ...
      text-slate-500 m-4 flex flex-col md:flex-row justify-between gap-4 p-4">
        <div className="flex min-w-[50%] justify-center items-center text-center flex-col gap-4 w-80">
          <h1 className="font-semibold text-xl shadow-md p-4">ABOUT US</h1>
      ...
      text-slate-500 m-4 flex flex-col-reverse md:flex-row justify-between gap-4 p-4">
        ...
        <div className="flex min-w-[50%] justify-center items-center text-center flex-col gap-4 w-80">
          <h1 className="font-semibold text-xl shadow-md p-4">VALUES & PHILOSOPHY</h1>
          <div>
            <p>Sustainability</p>
            <p>Ethical trade</p>
      ...
      text-slate-500 m-4 flex flex-col md:flex-row justify-between gap-4 p-4">
        <div className="flex min-w-[50%] justify-center items-center text-center flex-col gap-4 w-80">
          <h1 className="font-semibold text-xl shadow-md p-4">TEAM LOCALAID</h1>
            <p>
      ...
      text-slate-500 m-4 flex flex-col-reverse md:flex-row justify-between gap-4 p-4">
        ...
        <div className="flex min-w-[50%] justify-center items-center text-center flex-col gap-4 w-80">
          <h1 className="font-semibold text-xl shadow-md p-4">DESIGNER</h1>
