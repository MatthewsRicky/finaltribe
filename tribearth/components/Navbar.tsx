    ...
    <div className="relative w-full">
      <div className="w-full md:flex justify-between bg-emerald-100/90 items-center gap-4 px-4 py-6">
        <ul className="flex justify-between items-center">
          <li className="hover:scale-105 hover:bg-white p-4 rounded-lg transition duration-300">
            <Link href="/">
              <Image 
      ...
      >
        <ul className="w-full flex mt-0 flex-col md:flex-row justify-around items-center transition-all duration-300 bg-opacity-60 text-xl active:font-semibold ">
          ...
          <Link href="/shop" onClick={() => setIsOpen(!isOpen)}>
            <li className="py-4 hover:bg-emerald-500 hover:text-white hover:scale-105 w-full border-b-2 md:border-none mx-4 text-center border-emerald-500 rounded-lg justify-center"><DropdownMenu /></li>
          </Link>
