				...
				>
					<ul className="w-full text-slate-600 flex mt-0 flex-col md:flex-row justify-around items-center transition-all duration-300 bg-opacity-60 text-xl active:font-semibold mx-4">
						<Link
							...
							onClick={() => setIsOpen(!isOpen)}
						>
							<li className="py-4 hover:bg-emerald-500/60 hover:shadow-md hover:shadow-yellow-300/60 hover:text-white hover:scale-105 w-full border-b-2 md:border-none mx-4 text-center border-emerald-500 rounded-lg ">
								About
							</li>
						</Link>
						<Link
						...
						<Link href="/cart">
							<li className="py-4 hover:bg-emerald-500/60 hover:shadow-md hover:shadow-yellow-300/60 hover:text-white hover:scale-105 w-full border-b-2 md:border-none mx-4 justify-center items-center text-center border-emerald-500 rounded-lg">
								<AiFillShopping
									size={24}
									onClick={() => setIsOpen(!isOpen)}
								/>
