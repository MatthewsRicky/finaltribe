    ...
    <div className="w-full pt-32 relative flex flex-col">
      <div className="grid gap-x-6 gap-y-6 grid-row-1 md:grid-cols-2 justify-around items-center relative transition-all hover:bg-gradient-to-b from-yellow-500/20 to-emerald-300/20 duration-300 p-8 my-4 mx-4 shadow-lg">
        <div className="flex flex-col gap-y-2 shadow-lg hover:scale-105 hover:bg-white">
          ...
          <p className="flex p-8 text-lg md:text-xl mt-4 leading-7">Responsible sourcing of gemstones is of great importance to our brand. Our gemstones are sourced directly from ethical mines run by women in Kenya. We embrace traceability and sustainability throughout our complete supply chain.</p>
        </div>
        <Image
      ...
      <div className="flex justify-centers p-6 text-center m-10 text-xl font-semibold italic md:text-2xl bg-emerald-200/20 rounded-lg shadow-md">
        <h1 className="text-yellow-600/90">
      ...
      <div className="grid gap-x-6 gap-y-6 grid-row-1 md:grid-cols-2 justify-around items-center relative transition-all hover:bg-gradient-to-b from-yellow-500/20 to-emerald-300/20 duration-300 p-8 my-4 mx-4 shadow-lg">
        ...
        <div className="flex flex-col gap-y-2 shadow-lg hover:scale-105 hover:bg-white">
          ...
          <h2 className="flex p-4 font-medium text-yellow-600/90 bg-emerald-200/20 text-center rounded-md m-2 shadow-sm">FASHION IS THE LARGEST INDUSTRIAL EMPLOYER OF WOMEN AND LESS THAN 2% ARE ACTUALLY PAID A LIVING WAGE.</h2>
          <p className="flex p-8 text-lg md:text-xl mt-4 leading-7">Our vision is to empower women by providing them with fair and ethical means in which to earn a living. We promote gender equality in a sector that have long been male dominated. We place special emphasis on training and development that empowers the women working at the workshop.</p>
        </div>
      </div>
      <div className="grid gap-x-6 gap-y-6 grid-row-1 md:grid-cols-2 justify-around items-center relative transition-all hover:bg-gradient-to-b from-yellow-500/20 to-emerald-300/20 duration-300 p-8 my-4 mx-4 shadow-lg">
         <div className="flex flex-col gap-y-2 shadow-lg hover:scale-105 hover:bg-white">
          ...
          <p className="flex p-8 text-lg md:text-xl mt-4 leading-7">We are passionate about preserving our planet for future generations. Our workshop, based in Diani, Kenya, operates using sustainable interventions, such as our recycling plant which includes recycling waste material and water. Additionally, we recycle our waste metals to re-create designs. We are working on setting up solar systems for our power and water harvesting systems.</p>
        </div>
        <Image
          className="min-w-[50%] rounded-lg hover:scale-110"
